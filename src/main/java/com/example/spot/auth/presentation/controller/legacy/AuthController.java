...
public class AuthController {
    ...
    public ApiResponse<MemberResponseDTO.MemberInfoCreationDTO> signUpAndPartialUpdate(
        ...
        MemberResponseDTO.MemberInfoCreationDTO memberInfoCreationDTO = authService.signUpAndPartialUpdate(
                signUpDetailDTO);
...
//    }
    ...
    public ApiResponse<MemberResponseDTO.CheckMemberDTO> checkIsSpotMember() {
        MemberResponseDTO.CheckMemberDTO checkMemberDTO = authService.checkIsSpotMember(
