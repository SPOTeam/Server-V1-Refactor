...
/* ----------------------------- 진행중인 스터디 관련 API ------------------------------------- */
    ...
    public ApiResponse<StudyMemberResponseDTO.WithdrawalDTO> withdrawFromStudy(@PathVariable Long studyId) {
        StudyMemberResponseDTO.WithdrawalDTO withdrawalDTO = studyMemberCommandService.withdrawFromStudy(studyId);
    ...
    public ApiResponse<StudyMemberResponseDTO.WithdrawalDTO> withdrawHostFromStudy(
            @PathVariable Long studyId,
            @RequestBody StudyMemberRequestDTO.HostWithdrawDTO hostWithdrawDTO) {
        StudyMemberResponseDTO.WithdrawalDTO withdrawalDTO =
    ...
    public ApiResponse<StudyResponseDTO.TerminationDTO> terminateStudy(
            @PathVariable @ExistStudy Long studyId,
            @RequestParam @TextLength(min = 1, max = 30) String performance
    ) {
        StudyResponseDTO.TerminationDTO terminationDTO = studyMemberCommandService.terminateStudy(studyId, performance);
...
/* ----------------------------- 모집중인 스터디 관련 API ------------------------------------- */
    ...
    @Parameter(name = "studyId", description = "모집중인 스터디의 ID를 입력 받습니다.", required = true)
    @Parameter(name = "applicantId", description = "신청자의 ID를 입력 받습니다.", required = true)
    public ApiResponse<StudyMemberResponseDTO.ApplicationStatusDTO> rejectApplicant(
            @PathVariable @ExistStudy Long studyId,
            @PathVariable @ExistMember Long applicantId,
    ...
    @Parameter(name = "studyId", description = "모집중인 스터디의 ID를 입력 받습니다.", required = true)
    @Parameter(name = "applicantId", description = "신청자의 ID를 입력 받습니다.", required = true)
    public ApiResponse<StudyMemberResponseDTO.ApplicationStatusDTO> rejectApplicantForTest(
            @PathVariable @ExistStudy Long studyId,
            @PathVariable @ExistMember Long applicantId,
            @RequestParam boolean isAccept) {
        return ApiResponse.onSuccess(SuccessStatus._STUDY_APPLICANT_UPDATED,
