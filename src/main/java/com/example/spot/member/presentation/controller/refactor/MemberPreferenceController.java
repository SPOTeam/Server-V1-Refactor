...
public class MemberPreferenceController {
    ...
    public ApiResponse<MemberResponseDTO.MemberUpdateDTO> updateThemes(
        ...
        MemberResponseDTO.MemberUpdateDTO memberUpdateDTO = memberPreferenceService.updateTheme(
    ...
    public ApiResponse<MemberResponseDTO.MemberUpdateDTO> updateRegions(
        ...
        MemberResponseDTO.MemberUpdateDTO memberUpdateDTO = memberPreferenceService.updateRegion(
                SecurityUtils.getCurrentUserId(), requestDTO);
    ...
    public ApiResponse<MemberResponseDTO.MemberUpdateDTO> updateMemberStudyReason(
        ...
        MemberResponseDTO.MemberUpdateDTO memberUpdateDTO = memberPreferenceService.updateStudyReason(
                SecurityUtils.getCurrentUserId(), requestDTO);
    ...
    public ApiResponse<MemberResponseDTO.MemberThemeDTO> getThemes() {
        MemberResponseDTO.MemberThemeDTO memberThemeDTO = memberPreferenceService.getThemes(
    ...
    public ApiResponse<MemberResponseDTO.MemberRegionDTO> getRegions() {
        MemberResponseDTO.MemberRegionDTO memberRegionDTO = memberPreferenceService.getRegions(
                SecurityUtils.getCurrentUserId());
    ...
    public ApiResponse<MemberResponseDTO.MemberStudyReasonDTO> getStudyReasons() {
        MemberResponseDTO.MemberStudyReasonDTO memberStudyReasonDTO = memberPreferenceService.getStudyReasons(
                SecurityUtils.getCurrentUserId());
