...
import com.example.spot.refactor.member.domain.auth.CustomUserDetails;
import com.example.spot.refactor.member.domain.auth.RefreshToken;
import com.example.spot.refactor.member.domain.auth.RefreshTokenRepository;
import com.example.spot.refactor.member.application.auth.KaKaoOAuthService;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.MemberRegionDTO.RegionDTO;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.MemberSignInDTO;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.MemberStudyReasonDTO;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.MemberTestDTO;
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.SocialLoginSignInDTO;
import com.example.spot.refactor.member.presentation.dto.kakao.KaKaoOAuthToken.KaKaoOAuthTokenDTO;
import com.example.spot.refactor.member.presentation.dto.kakao.KaKaoUser;
...
import com.example.spot.refactor.member.presentation.dto.MemberResponseDTO.MemberUpdateDTO;
