package com.example.spot.legacy.api.code.status;

import com.example.spot.legacy.api.code.BaseErrorCode;
import com.example.spot.legacy.api.code.ErrorReasonDTO;
